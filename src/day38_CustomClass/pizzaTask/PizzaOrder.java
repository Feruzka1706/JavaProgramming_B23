...
public class PizzaOrder {
    public static void main(String[] args) {
        ...
        //add 30 medium pizza with 2 cheese topping and 2 pepperoni toppings
        for(int i=1; i<=30; i++){
        ...
        //add 38 small pizza with 2 cheese toppings and 1 pepperoni toppings
        for(int i=1; i<=38; i++){
            Pizza pizza=new Pizza();
        ...
        System.out.println("Toatl nnumber of Pizza: "+pizzas.size() );
