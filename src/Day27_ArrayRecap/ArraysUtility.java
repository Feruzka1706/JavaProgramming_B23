...
public class ArraysUtility {
    public static void main(String[] args) {
        ...
        //we want to make have 5 elements and we want to have above array's elements here also
        ...
        char[] first10Letters=Arrays.copyOfRange(characters,0,9+1); //we need to add9+1
